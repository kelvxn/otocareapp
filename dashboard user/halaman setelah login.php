        ...
        ***********************************-->
        ...
        <div class="nav-header">
            ...
            <a href="halaman setelah login.php">
                    <b class="logo-abbr"><img src="images/logoss.png" alt=""> </b>
                    <span class="logo-compact text-white"><img src="./images/comp.png" class="pt-2 md-6" width="150" height="70" alt=""></span>
                    <span class="brand-title">
                        <h1 class="text-center pt-3 text-white">  <img src="images/logoss.png"  class="me-2" width="50" height="50" alt=""> Otocare</h1>
                    </span>
                </a>
            </div>
        </div>
   ...
   ?>
      ...
      <div class="container pt-5 pb-3">
        <?php
          ...
          ?>
        <h1 class="ms-5">Hi! <?php echo $data['nama']; ?></h1>
    ...
    <section id="layanan">
      <div class="container-fluid layanan pt-5 pb-5">
        <div class="container text-center">
          ...
          <p>Mengapa harus booking bengkel di OTOCARE?</p>
          <div class="row pt-4">
            <div class="col-md-4">
      ...
      ?>
              ...
              <div class="card" style="width: 18rem">
                ...
                <div class="card-body">
                  ...
                  <a href="detail.php?id=<?php echo $data2['id_bengkel']; ?>" class="btn btn-warning">Lihat Detail</a>
                </div>
              </div>
...
?>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#F3F3F9"
          fill-opacity="1"
          d="M0,32L30,53.3C60,75,120,117,180,128C240,139,300,117,360,96C420,75,480,53,540,69.3C600,85,660,139,720,149.3C780,160,840,128,900,138.7C960,149,1020,203,1080,192C1140,181,1200,107,1260,90.7C1320,75,1380,117,1410,138.7L1440,160L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"
        ></path>
      </svg>
    </section>
    ...
    <section id="maps">
      ...
      <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#030303"
          fill-opacity="1"
          d="M0,96L34.3,133.3C68.6,171,137,245,206,272C274.3,299,343,277,411,245.3C480,213,549,171,617,149.3C685.7,128,754,128,823,149.3C891.4,171,960,213,1029,208C1097.1,203,1166,149,1234,144C1302.9,139,1371,181,1406,202.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"
        ></path>
      </svg> -->
    </section>
    <!-- Kontak -->
