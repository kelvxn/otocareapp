  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <form action="simpan data.php" class="form-horizontal" style="margin: 20px;" method="post" enctype="multipart/form-data">
                <!-- <div class="form-group cols-sm-6">
                  <label>Id Bengkel</label>
                  <input type="text" name="id_bengkel" value="" class="form-control"/>
                </div> -->
                <div class="form-group cols-sm-6">
                  ...
                  <!-- <div class="form-group cols-sm-6">
                    ...
                    <input type="text" name="id_owner" value="" class="form-control"/>
                  </div> -->
        ...
        //   $sql=mysqli_query($conn,"select distinct id_user from user where role='owner'");
        // $cek=mysqli_num_rows($sql);
        // $data=mysqli_fetch_array($sql);
        // if($cek>0){
        //   $id=$data['id_user'];
        //   $sql0=mysqli_query($conn,"select id_owner from bengkel where id_owner IS NOT NULL");
             ...
             ?>
                  ...
                  <div class="form-group cols-sm-6">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="contohupload2" name="img">
